...
for filename in files:
    if filename.endswith('.bc'):
        ...
        if filename == 'direct1.bc':
            ...
            if result.find('File: array1.c, Line: 16') != -1: passed = False
            if result.find('File: array1.c, Line: 17') != -1: passed = False
            if result.find('File: array1.c, Line: 18') != -1: passed = False
            ...
            if result.find('File: array2.c, Line: 11') == -1: passed = False
            if result.find('File: array2.c, Line: 12') != -1: passed = False
            if result.find('File: array2.c, Line: 13') != -1: passed = False
            if result.find('File: array2.c, Line: 14') != -1: passed = False
            ...
            if result.find('File: array2.c, Line: 22') == -1: passed = False
            if result.find('File: array2.c, Line: 23') == -1: passed = False
